<template>
	<view class="x-bg min-vh-100 pb-20 pt-50" :style="`--url:url(https://res.vkunshan.com/order/bg_gradient.png?x-oss-process=image/resize,w_${dpr*375})`">
		<!-- #ifdef H5 -->
...
<style lang="scss" scoped>
	.x-bg {
		background: var(--url)left top -10px / contain no-repeat
	}
