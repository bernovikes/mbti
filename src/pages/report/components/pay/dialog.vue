	...
	<uni-popup ref="pop" type="bottom">
		<view class="x-pay-dialog">
			<view class="x-pay-dialog__header">
				<view class="tr">
					<view @click="pop.close" class="x-close dib tc white f7 inline-flex items-center justify-center">✕</view>
				</view>
			...
			<view class="bg-white pt-20 pl-20 pr-20 pb-18">
				<view class="pl-68 pr-68">
					<view class="x-pay-dialog__goods pt-22 relative  tc">
						<view class="absolute x-pay-goods-top">
							<view class="x-pay-submark font-11 lh-20 white fw5">超值升级</view>
						</view>
						<view class="f6 fw6 lh-20 color-616161">完整解析报告</view>
						<view class="font-26 color-3d8dff font-dina b"><text class="f6">¥</text>{{goods.discount_price}}</view>
						<view class="f7 lh-20 fw5 color-c3c3c3 strike">¥{{goods.origin_price}}</view>
						<view class="white font-11 fw4 lh-20 x-pay-dialog__goods-bottom">已减¥{{goods.origin_price-goods.discount_price}}</view>
					</view>
				</view>
				<!--  -->
